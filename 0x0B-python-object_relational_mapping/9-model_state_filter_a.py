...
if __name__ == "__main__":
    ...
    # The connection pool provides a source of distinct Connection objects that are owned by the application, for use with the database.
    engine = create_engine("mysql+mysqldb://{}:{}@localhost:3306/{}"
                           .format(sys.argv[1], sys.argv[2], sys.argv[3]))

    # This is the function that allows you to interact with the database
    # In order to do so, you need a session, which is an abstraction layer over the transactional system
