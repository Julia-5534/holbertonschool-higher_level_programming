...
if __name__ == "__main__":
    ...
    # It’s “home base” for the actual database and
    # its DBAPI, delivered to the SQLAlchemy application
    # through a connection pool and a Dialect.
    ...
    # This is the function that allows you to
    # interact with the database
    # In order to do so, you need a session,
    # which is an abstraction layer over the
